...
- For environment setup or verification, read `docs/codex-environment.md` and use `scripts/codex-service.py` from the parent repository. When working directly inside a service, use its Poetry commands with that service as the working directory.
